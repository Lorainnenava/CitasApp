...
namespace MyApp.Tests.Mocks
{
    public class MockUserSession
    {
        ...
        public static List<RoleSubModulePermissionsEntity> MockRoleSubModulePermission()
        {
            return [
                new() {
                    SubModulePermission = new SubmodulePermissionsEntity
                    {
                        SubModule = new SubModulesEntity { Route = "USUARIOS" },
                        Permission = new PermissionsEntity { Code = "VIEW" }
                    }
                }
            ];
        }
