...
namespace MyApp.Tests.Application.UserSessions
{
    public class UserSessionCreateUseCaseTests
    {
        ...
        private readonly Mock<IGenericRepository<RoleSubModulePermissionsEntity>> _roleSubModulePermissionRepoMock;
        ...
        public UserSessionCreateUseCaseTests()
        {
            ...
            _roleSubModulePermissionRepoMock = new Mock<IGenericRepository<RoleSubModulePermissionsEntity>>();
            ...
            _useCase = new UserSessionCreateUseCase(
                ...
                _roleSubModulePermissionRepoMock.Object,
                _loggerMock.Object
            );
        }
        ...
        public async Task Execute_WithValidCredentials_ReturnsAccessAndRefreshToken()
        {
            ...
            _roleSubModulePermissionRepoMock
                .Setup(r => r.GetAll(
                    It.IsAny<Expression<Func<RoleSubModulePermissionsEntity, bool>>>(),
                    It.IsAny<Expression<Func<RoleSubModulePermissionsEntity, object>>>(),
                    It.IsAny<Expression<Func<RoleSubModulePermissionsEntity, object>>>()
                ))
                .ReturnsAsync(MockUserSession.MockRoleSubModulePermission());
